...
### 2026-08-02 — 전체 원고 보기 모달

- 목적: 칸반 「원고 복사」·「.txt 저장」을 미리보기 모달로 통합
- 변경: `ManuscriptPreviewModal`, `formatManuscriptPlain`·시각 스탬프 파일명, 구간 필터·인라인 제외 슬롯·제목 토글, PRD/SRS/TRD/README/AGENTS
- UX: 보더리스 이어진 미리보기·푸터 스위치·제외 슬롯 `제목 - 본문`·모달 ~640px
- 명령: typecheck 통과
- 판정: 채택

### 2026-08-02 — 전체 원고 보기 문서 현행화

- 목적: 모달 UX·평문 규칙을 SRS/TRD/PRD/README/AGENTS에 맞춤
- 변경: 구간 「전체」토글·인라인 제외 미리보기·헤더/푸터 배치·파일명·「비트」미사용 문구 정리
- 판정: 채택

### 2026-08-02 — 전체 원고 보기 최종 점검
